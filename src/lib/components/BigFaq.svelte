...
<div class="text-white">
	...
	{#if section === 'general'}
		<div class="fade-in">
			<div class="my-4 font-encode text-xl font-bold text-white xl:text-2xl">General</div>
	...
	{:else if section === 'accommodations'}
		<div class="fade-in">
			<div class="mb-4 mt-4 font-encode text-xl font-bold text-white xl:text-2xl">
				Accommodations
			</div>
