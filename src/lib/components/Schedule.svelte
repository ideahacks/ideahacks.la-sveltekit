<ul class="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical font-encode">
    <li>
      ...
      <div class="timeline-start mb-10 md:text-end">
        <time class="font-mono italic">6:00-6:45 PM</time>
        <div class="text-lg font-black font-paytone">IDEA Hacks Kickoff</div>
