...
<section class="relative h-screen w-screen overflow-hidden">
	<div class="absolute inset-0 bg-gradient-to-b from-black/95 to-blue-950/95" />
...
<section class="bg-gradient-to-b from-blue-950/95 to-[#2775af] pt-8 text-white">
	<!-- CLOUDS -->
	{#if wave1}
		<img
			src={cloud1}
			...
			alt="cloud"
			class="absolute -left-96 top-10 z-0 w-96 opacity-25"
		/>
		<img
			src={cloud2}
			transition:fly={{ duration: 20000, x: '50vw', opacity: 1, easing: linear }}
			alt="cloud"
			class="absolute -left-96 top-96 z-0 w-96 opacity-25"
		/>
		<img
			src={cloud2}
			transition:fly={{ duration: 30000, x: '100vw', opacity: 1, easing: linear }}
			alt="cloud"
			class="absolute -left-96 bottom-20 z-0 w-96 opacity-25"
		/>
	{/if}
	...
	{#if wave2}
		<img
			...
			transition:fly={{ duration: 50000, x: '150vw', opacity: 1, easing: linear }}
			alt="cloud"
			class="absolute -left-96 top-36 z-0 w-96 opacity-25"
		/>
		<img
			src={cloud4}
			transition:fly={{ duration: 50000, x: '125vw', opacity: 1, easing: linear }}
			alt="cloud"
			class="absolute -left-96 bottom-36 z-0 w-96 opacity-25"
		/>
	{/if}
	...
	{#if wave3}
		<img
			...
			alt="cloud"
			class="absolute -left-96 bottom-32 z-0 w-96 opacity-25"
		/>
		<img
			src={cloud1}
			transition:fly={{ duration: 50000, x: '150vw', opacity: 1, easing: linear }}
