...
<div class="p-4 text-white">
	...
	<div class="mb-4 font-mono text-2xl text-white">GENERAL</div>
	...
	<div class="mb-4 mt-10 font-mono text-2xl text-white">ACCOMMODATIONS</div>
	...
	<div class="mb-4 mt-10 font-mono text-2xl text-white">APPLICATIONS</div>
	...
	<div class="mb-4 mt-10 font-mono text-2xl text-white">SUSTAINABILITY</div>
	...
	<div class="mb-4 mt-10 font-mono text-2xl text-white">MISCELLANEOUS</div>
